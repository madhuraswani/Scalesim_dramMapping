...
class single_layer_sim:
    ...
    def run(self):
        ...
        if not self.memory_system_ready_flag:
            ...
            self.memory_system.set_params(
                    ...
                    ifmap_backing_buf_banks=ifmap_banks, 
                    filter_backing_buf_banks=filter_banks
            )
    ...
    def save_traces(self, top_path):
        ...
        self.memory_system.print_ifmap_dram_trace_multibank(ifmap_dram_filename)
        ...
        self.memory_system.print_filter_dram_trace_multibank(filter_dram_filename)
