...
class double_buffered_scratchpad:
    ...
    def set_params(self,
                   ...
                   ifmap_backing_buf_banks=1, filter_backing_buf_banks=1):
        ...
        if self.estimate_bandwidth_mode:
            ...
            self.ifmap_buf.set_params(backing_buf_obj=self.ifmap_port,
                                      ...
                                      word_size=word_size,
                                      active_buf_frac=rd_buf_active_frac,
                                      backing_buf_bw=ifmap_backing_buf_bw,num_banks=ifmap_backing_buf_banks)

            self.filter_buf.set_params(backing_buf_obj=self.filter_port,
                                       total_size_bytes=filter_buf_size_bytes,
                                       word_size=word_size,
                                       active_buf_frac=rd_buf_active_frac,
                                       backing_buf_bw=filter_backing_buf_bw,num_banks=filter_backing_buf_banks)
    ...
    def get_ifmap_dram_multibank_trace_matrix(self):
        return self.ifmap_buf.get_multibank_trace_matrix()

    #
    def get_filter_dram_trace_matrix(self):
        return self.filter_buf.get_trace_matrix()
    
    def get_filter_dram_multibank_trace_matrix(self):
        return self.filter_buf.get_multibank_trace_matrix()

    #
    def get_ofmap_dram_trace_matrix(self):
        return self.ofmap_buf.get_trace_matrix()
    
    def get_ofmap_dram_multibank_trace_matrix(self):
        return self.ofmap_buf.get_multibank_trace_matrix()
    ...
    def get_dram_multibank_trace_matrices(self):
        dram_ifmap_trace = self.ifmap_buf.get_multibank_trace_matrix()
        dram_filter_trace = self.filter_buf.get_multibank_trace_matrix()
        dram_ofmap_trace = self.ofmap_buf.get_multibank_trace_matrix()
    ...
    def print_ifmap_dram_trace_multibank(self,filename):
        self.ifmap_buf.print_multibank_trace(filename)

    def print_ofmap_dram_trace_multibank(self,filename):
        self.ofmap_buf.print_multibank_trace(filename)
    
    def print_filter_dram_trace_multibank(self,filename):
        self.filter_buf.print_multibank_trace(filename)
